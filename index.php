...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => 'Zakłady', 'file' => '1.php'),
		'1'	=> array('id' => '2', 'alias' => 'Nowy-zakład', 'file' => '2.php'),
		'2'	=> array('id' => '3', 'alias' => 'Druzyny', 'file' => '3.php')
	);
	$forms = array(
	...
	$user_key = "0TwXSLLrrkzpIAeEmLk=";
	$user_hash = "e479450de4c73075";
	$comment_callback = "http://uk.zyro.com/pl-PL/comment_callback/";
	$preview = false;
	$mod_rewrite = true;
